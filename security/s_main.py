...
oauth2_scheme = OAuth2PasswordBearer(tokenUrl="token", scopes={"author": "Read information about the current user."})
...
async def get_current_active_user(current_user: User = Security(get_current_user, scopes=["author"])):  # UserInDB
    return current_user
